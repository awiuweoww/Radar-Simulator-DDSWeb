...
{
  return OpenDDS::DCPS::getCompleteTypeIdentifier<OpenDDS::DCPS::RadarTrack_TrackData_xtag>();
}

const OpenDDS::XTypes::TypeMap& TrackDataTypeSupportImpl::getCompleteTypeMap() const
{
  return OpenDDS::DCPS::getCompleteTypeMap<OpenDDS::DCPS::RadarTrack_TrackData_xtag>();
}
