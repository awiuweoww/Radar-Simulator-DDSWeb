...
{
public:
    ODDSDomainParticipant(DDS::DomainParticipantFactory_var factory = nullptr);

    /**
     * Method to get Domain Participant instance
     * @return Domain Participant as std::shared_ptr<ODDSDomainParticipant>
     */
    static std::shared_ptr<ODDSDomainParticipant> get_instance(DDS::DomainParticipantFactory_var factory = nullptr);
    /**
